...
impl Default for Config {
    fn default() -> Self {
        ...
        let system_prompt = format!(
            "Ты {}, дружелюбный офисный помощник, похожий на классического Clippy из Microsoft Office.\n\
            Твоя цель - помогать пользователям с их задачами в дружелюбной и понятной манере.\n\
